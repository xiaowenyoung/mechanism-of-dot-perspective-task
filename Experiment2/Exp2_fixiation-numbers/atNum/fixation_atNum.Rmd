---
title: "EXP2_fixationNumbers_facedAt"
date: "2024.03.04"
output:
  html_document:
    code_folding: hide
...
summary(m3.at.full)
isSingular(m3.at.full) #Check for singular fits
...
p<-ggplot(mean_df, aes(x = type, y = mean_atNum, 
...
p3 <- p2 + geom_beeswarm(data = mean_df, aes(y = mean_atNum),
                         dodge.width = 0.9,
...
ggsave(p4, filename = "exp2_atNum.pdf", dpi = 500,
